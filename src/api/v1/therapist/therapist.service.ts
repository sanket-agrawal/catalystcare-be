    ...
    try {
      ...
      return bookings.map((booking) => {
        ...
        return {
          ...
          sessionNote: booking.sessionNote || null,
          clientMessage: booking.sessionNote?.sessionSummary || null,
          message: booking.sessionNote?.sessionSummary || null,
  ...
  try {
    ...
    return bookings.map((b) => {
      ...
      return {
        ...
        sessionNote: b.sessionNote || null,
        clientMessage: b.sessionNote?.sessionSummary || null,
        message: b.sessionNote?.sessionSummary || null,
